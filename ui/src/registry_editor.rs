...
use prefix::registry::{RegistryEditor, RegEditor};
                ...
                if !self.prefix_path.as_os_str().is_empty() {
                    ...
                    if warm {
                        ...
                        let load_vd = || -> Option<VirtualDesktopSettings> {
                            ...
                            let size = prefix::registry::keys::DesktopSize::from_string(&sz)
                                .unwrap_or_else(|| prefix::registry::keys::DesktopSize::new(1024, 768));
